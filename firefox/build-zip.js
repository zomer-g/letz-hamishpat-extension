#!/usr/bin/env node
// Build a clean, AMO-ready ZIP of the Firefox extension.
// Excludes: docs (.md), build script, samples/, dist/, .git, node_modules, source maps.
//
// Run:  node build-zip.js
// Output: dist/firefox-extension-v{version}.zip
...
async function main() {
  ...
  const zipPath = path.join(DIST, `firefox-extension-v${version}.zip`);
