...
(function (root) {
  ...
  function findCourtSelect(doc) {
    return doc.querySelector('select[id*="ComboBoxCourt"], select[name*="ComboBoxCourt"], select[id*="Court"][id*="ComboBox"]');
  }
  function findJudgeSelect(doc) {
    return doc.querySelector('select[id*="ComboBoxJudge"], select[name*="ComboBoxJudge"], select[id*="Judge"][id*="ComboBox"]');
  }
