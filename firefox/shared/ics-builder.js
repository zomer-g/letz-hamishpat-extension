...
(function (root) {
  ...
  function buildVEvent(ev) {
    ...
    if (t) {
      const endH = t.h + 1;
      const end = endH >= 24
        ? { y: d.y, m: d.m, d: d.d + 1, h: endH - 24, min: t.min }
        : { y: d.y, m: d.m, d: d.d, h: endH, min: t.min };
