...
**איתור תיק לפי תיק מקור**
- חיפוש תיק בית משפט לפי מספר תיק המקור שלו (דו"ח תעבורה, תיק משטרתי (פל"א), תיק הוצל"פ, הודעת קנס ועוד) — מתוך שורת האיתור המהיר.
- בחלונית התוסף: הדבקת רשימה שלמה של מספרי תיק מקור, וקבלת טבלה של תיקי בית המשפט שנמצאו לכל אחד — להעתקה לאקסל או לייצוא CSV.
